...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Task fina = new Task("Final", 0);
        Task H = new Task("H", 1, fina);
        Task K = new Task("K", 4, H);
        Task G = new Task("G", 2, H);
        Task F = new Task("F", 3, H);
        Task E = new Task("E", 1, G,K);
        Task D = new Task("D", 2, F,G);
        Task C = new Task("C", 3, F);
        Task B = new Task("B", 2, D, E);
        Task A = new Task("A", 3, C,D);
        Task start = new Task("Start", 0, A, B);
        allTasks.add(fina);
        allTasks.add(H);
        allTasks.add(K);
        allTasks.add(G);        
